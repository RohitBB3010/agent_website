    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            if (docSnap.exists()) {
                ...
                const num_of_customers = data['num_of_customers'];
                const claims_successful = data['claims_successful'];
                const claims_failed = data['claims_failed'];
    ...
    return (
        <div className="stat-component">
            ...
            <div className="hero-text">
                {statData}
                {statField === 'Claim Success Rate' ? '%' : '+'} {statField}
            </div>
        </div>
    );
}
